...
*                                                                                                  *
*  FILENAME:                                                                                      */
/**\file        api_lib_eepRC.h
*
*  \brief       Summarisation of public defines of API library eepRC.
...
#ifndef _API_LIB_EEPRC_H_D      /* replace it with the filename in capital letters */
#define _API_LIB_EEPRC_H_D      /* replace it with the filename in capital letters */
...
#include "eep_Func.h"
#include "eep_FuncExtra.h"
#include "numbers_eepRC.h"

#endif // _API_LIB_EEPRC_H_D
