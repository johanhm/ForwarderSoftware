...
*                                                                                                  *
*  FILENAME:                                                                                      */
/**\file        api_lib_dflash.h
*
*  \brief       Summarisation of public defines of API library dflash.
...
#ifndef _API_DFLASH_H_D      /* replace it with the filename in capital letters */
#define _API_DFLASH_H_D      /* replace it with the filename in capital letters */
...
#include "dflash.h"
#include "dflash_Func.h"
#include "dflash_FuncExtra.h"

#include "dflash_FuncMapEep.h"

#endif // _API_DFLASH_H_D
